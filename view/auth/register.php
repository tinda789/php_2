...
<div class="auth-form">
    ...
    <form method="post" action="?controller=auth&action=register">
        ...
        <input type="text" name="first_name" id="first_name" required placeholder="Nhập họ...">
        <label for="last_name">Tên</label>
        <input type="text" name="last_name" id="last_name" required placeholder="Nhập tên...">
    ...
    <p class="auth-link">Đã có tài khoản? <a href="?controller=auth&action=login">Đăng nhập</a></p>
</div>
<style>
.auth-form {
    max-width: 400px;
